...
def run_finetuning_function(output_filename, model_load_path, model_save_path, num_patient_noise_files, num_control_noise_files, extract_coeffs):
    ...
    for epoch in range(20):
        ...
        loss, avg_loss, _ = run_epoch(model, 
              ...
              extract_coeffs=extract_coeffs, number_coeffs=128)
        model.eval()
    ...
    print(run_epoch(model, LossCompute(model.generator, model.softgenerator, None, pretrain=False),
                    ...
                    extract_coeffs=extract_coeffs, number_coeffs=128), file=output_file)
