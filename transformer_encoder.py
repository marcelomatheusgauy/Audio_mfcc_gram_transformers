...
class TransformerEncoder(nn.Module):
    def __init__(self, encoder, src_embed, generator, softgenerator):
...
class Generator(nn.Module):
    ...
    def __init__(self, d_model, vocab, pretrain=True):
...
def make_transformer_encoder_model(n_coeffs, out_coeffs, N=6, d_model=512, d_ff=2048, h=8, dropout=0.1):
    c = copy.deepcopy
    ...
    model = TransformerEncoder(
        ...
        Generator(d_model, n_coeffs, True),
        Generator(d_model, out_coeffs, False))
    model.cuda()
